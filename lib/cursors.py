...
class BlittedCursor:
    ...
    """
    def __init__(self, ax, color, linewidth, linestyle="--", print_text=False):
        self.ax = ax
        self.background = None
        self.color = color
        self.linewidth = linewidth
        self.linestyle = linestyle
        self.horizontal_line = ax.axhline(color=self.color, lw=self.linewidth, ls=self.linestyle)
...
class SnappingCursor:
    ...
    """
    def __init__(self, ax, line, color, linewidth, linestyle="-", print_text=False):
        self.ax = ax
        self.background = None
        self.color = color
        self.linewidth = linewidth
