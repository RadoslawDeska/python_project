...
from zscan1 import (Integration,SILICA_BETA,N_COMPONENTS,INTEGRATION_STEPS)
...
tos = []
tcs = []
for dp in [0,0.2,0.45]:
    silica_curves = Integration(
        SILICA_BETA,silica_n2,dp,positions,d0,ra,lda,silicaCA_beamwaist,N_COMPONENTS,INTEGRATION_STEPS)
